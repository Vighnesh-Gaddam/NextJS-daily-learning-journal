          ...
          >
            <div className="relative">
              <img
                src={game.image}
                alt={game.title}
                className="w-full h-52 object-cover rounded-lg group-hover:opacity-50 transition"
              />
              <div className="absolute inset-0 bg-black bg-opacity-30 rounded-lg opacity-0 group-hover: transition"></div>
            </div>
